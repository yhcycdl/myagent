...
这个实现基本按 [多模态客服智能体比赛执行说明.md](/home/cyh/agent/多模态客服智能体比赛执行说明.md) 的路线来搭，但做了两个务实修正：

1. 公开题里混有大量订单、售后、投诉、退款类问题，不是纯说明书问答，所以系统加了一个保守的通用客服兜底。
2. 原始手册里至少有一份英文汇总文件格式不规范，知识库构建脚本会跳过坏文件并继续构建，不让整体流程中断。
